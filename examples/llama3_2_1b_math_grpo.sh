...
MODEL_PATH=meta-llama/Llama-3.2-1B-Instruct  # replace it with your local file path

python3 -m verl.trainer.main \
    config=/home/hpc/b273dd/b273dd11/EasyR1/examples/config_debug.yaml \
